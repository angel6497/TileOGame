...
// line 140 "../../../../../TileO(updatedMar22).ump"
public abstract class Tile implements Serializable
{
  ...
  public boolean setHasBeenRevealed(boolean aHasBeenRevealed)
  {
    boolean wasSet = false;
    hasBeenRevealed = aHasBeenRevealed;
    wasSet = true;
    return wasSet;
  }
  ...
  // line 164 "../../../../../TileO(updatedMar22).ump"
  ...
  public String toString()
  {
    ...
    return super.toString() + "["+
            "x" + ":" + getX()+ "," +
            "y" + ":" + getY()+ "," +
            "hasBeenVisited" + ":" + getHasBeenVisited()+ "," +
            "hasBeenRevealed" + ":" + getHasBeenRevealed()+ "]" + System.getProperties().getProperty("line.separator") +
...
// line 151 ../../../../../TileO(updatedMar22).ump
  @Override
